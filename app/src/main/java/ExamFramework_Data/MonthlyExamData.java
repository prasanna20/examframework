...
/**
 * Created by Prasanna on 13-11-2016.
 */

public class MonthlyExamData {
    ...
    public MonthlyExamData() {
    }

    public MonthlyExamData(int id,int QuesNo,String Ques,String Choice1,String Choice2,String Choice3,String Choice4,String Choice5,int CorrectAns,String Category)
    {
        super();
        this.id=id;
        this.QuesNo=QuesNo;
    ...
    public int getansweredFlag() {return answeredFlag;}

    public void setansweredFlag(int answeredFlag) {this.answeredFlag = answeredFlag;}
    ...
    public void setChoic4(String Choice4) {this.Choice4 = Choice4;}
